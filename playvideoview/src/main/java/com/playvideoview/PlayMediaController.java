...
public class PlayMediaController extends FrameLayout {


    private PlayMediaController.MediaPlayerControl mPlayer;
...
//    private boolean mFullscreenEnabled = false;
    ...
    public PlayMediaController(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.PlayMediaController);
        mScalable = a.getBoolean(R.styleable.PlayMediaController_pvv_scalable, false);
        a.recycle();
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        View viewRoot = inflater.inflate(R.layout.pvv_player_controller, this);
    ...
    public void reset() {
        ...
        mTurnButton.setImageResource(R.drawable.pvv_player_player_btn);
    ...
    private void updatePausePlay() {
        if (mPlayer != null && mPlayer.isPlaying()) {
            mTurnButton.setImageResource(R.drawable.pvv_stop_btn);
//            mCenterPlayButton.setVisibility(GONE);
        } else {
            mTurnButton.setImageResource(R.drawable.pvv_player_player_btn);
//            mCenterPlayButton.setVisibility(VISIBLE);
    ...
    void updateScaleButton() {
        if (mIsFullScreen) {
            mScaleButton.setImageResource(R.drawable.pvv_star_zoom_in);
        } else {
            mScaleButton.setImageResource(R.drawable.pvv_player_scale_btn);
        }
    }
