...
/*
 * Copyright (C) 2021 Author <dictfb#gmail.com>
 *
...
public class PlayVideoView extends SurfaceView
        implements PlayMediaController.MediaPlayerControl,OrientationDetector.OrientationChangeListener{
    private String TAG = "PlayVideoView";
    ...
    public PlayVideoView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mContext = context;
        TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.PlayVideoView,0,0);
        mFitXY = a.getBoolean(R.styleable.PlayVideoView_uvv_fitXY, false);
        mAutoRotation = a.getBoolean(R.styleable.PlayVideoView_uvv_autoRotation, false);
        a.recycle();
        initVideoView();
    }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(PlayVideoView.class.getName());
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            info.setClassName(PlayVideoView.class.getName());
        }
    }
    ...
    public void setMediaController(PlayMediaController controller) {
...
//                    }
    ...
    private void enableOrientationDetect() {
        if (mAutoRotation && mOrientationDetector == null) {
            ...
            mOrientationDetector.setOrientationChangeListener(PlayVideoView.this);
